...
class ProductModuleProduct(models.Model):
    ...
    product_type_ids = fields.Many2many('product_module.type', string='Product Jobs', help='Select multiple jobs for this product')
    ...
    material_ids = fields.Many2many('product_module.material', string='Materials', help='Materials used in this product')
    ...
    def action_export_instructions(self):
        ...
        # Write process data with product info in each row
