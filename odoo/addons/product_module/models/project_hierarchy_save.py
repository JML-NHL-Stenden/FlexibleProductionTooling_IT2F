...
class ProductModuleProjectHierarchySave(models.Model):
    ...
    def action_sync_staged_hierarchy_to_arkite(self):
        ...
        # The dirty flags are sometimes updated via SQL in step.write() while the Project record
        # stays cached in the current request/controller. Force a refresh so the button reflects reality.
